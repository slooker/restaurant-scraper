RestaurantInspections::Application.routes.draw do
  resources :inspections, except: [:new, :edit]
  resources :violations, except: [:new, :edit]
  ...
  get '/restaurants/:id/all' => 'restaurants#all'
  ...
  get '/categories' => 'restaurants#categories'
